...
export default class TableComponent {
    ...
    applyFilter(event: Event, column: any) {
        ...
        this.dataSource.filter = Object.keys(this.filteredValues).length ? JSON.stringify(this.filteredValues) : '';
    ...
    toggleColumn(column: any) {
        ...
        this.columnsToDisplay = ['select', ...this.columns.filter((i) => !this.hiddenColumns.includes(i)), 'option'];
    }
}
